                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-header" style="display: flex; justify-content: center;">
                            <h2 class="fw-medium fs-base">Tambah List Showcase</h2>
                        </div>

                        <!-- BEGIN: Modal Body -->
                        <form action="{{ route('create.showcase') }}" method="POST">
                            @csrf
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <select id="category" name="category_id" class="form-select">
                                        ...
                                        @foreach ($categories as $category)
                                            @php
                                                $isShowCaseRoute = Route::is('showcase');
                                                $isShowCaseCategory =
                                                    strtolower($category->category_name) === 'show case';
                                            @endphp
                                            @if (($isShowCaseRoute && $isShowCaseCategory) || (!$isShowCaseRoute && !$isShowCaseCategory))
                            ...
                            <div id="edit-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('update.showcase', ['id' => $item->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('patch')
                            ...
                            <div id="itemIn-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('itemIn.showcase', ['id' => $item->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('patch')
                            ...
                            <div id="itemOut-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('itemOut.showcase', ['id' => $item->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('patch')
                                            <div class="modal-body d-flex justify-content-center align-items-center">
        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                <div class="bg-light text-center rounded p-4 h-100">
                    ...
                    <canvas height="250" id="showcaseChart"></canvas>
                </div>
            </div>
            <div class="col-sm-12 col-xl-6 hidden" id="monthlyContainer">
                <div class="bg-light text-center rounded p-4 h-100">
                    ...
                    <canvas height="250" id="monthShowcaseChart"></canvas>
                </div>
            </div>
            <div class="col-sm-12 col-xl-6">
                <div class="bg-light text-center rounded p-4 h-100">
                    ...
                    <canvas height="250" id="showcaseStok"></canvas>
                </div>
            </div>
        </div>
    </div>
...
@section('jsPage')
    <script>
        ...
        $(document).ready(function() {
            var ctx1 = $("#showcaseChart").get(0).getContext("2d");
        ...
        $(document).ready(function() {
            var ctx1 = $("#monthShowcaseChart").get(0).getContext("2d");
        ...
        document.addEventListener("DOMContentLoaded", function() {
            var ctx1 = document.getElementById("showcaseStok").getContext("2d");
        ...
        document.getElementById('showMonthlyButton').addEventListener('click', function() {
            ...
            document.getElementById('showcaseChart').parentElement.parentElement.classList.add('hidden');
        });
        ...
        document.getElementById('showDailyButton').addEventListener('click', function() {
            ...
            document.getElementById('showcaseChart').parentElement.parentElement.classList.remove('hidden');
        });
    </script>
@endsection
