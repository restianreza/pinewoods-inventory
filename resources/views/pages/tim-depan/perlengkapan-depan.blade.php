    ...
    <div class="container-fluid pt-4 px-4">
        <div class="bg-light rounded p-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h6 class="mb-0">Perlengkapan Depan</h6>
                <div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-header" style="display: flex; justify-content: center;">
                            <h2 class="fw-medium fs-base">Tambah List Perlengkapan Depan</h2>
                        </div>

                        <!-- BEGIN: Modal Body -->
                        <form action="{{ route('create.perlengkapan-depan') }}" method="POST">
                            @csrf
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <select id="category" name="category_id" class="form-select">
                                        ...
                                        @foreach ($categories as $category)
                                            @php
                                                $isPerlengkapanDepanRoute = Route::is('perlengkapan-depan');
                                                $isPerlengkapanDepanCategory =
                                                    strtolower($category->category_name) === 'perlengkapan depan';
                                            @endphp
                                            @if (
                                                ($isPerlengkapanDepanRoute && $isPerlengkapanDepanCategory) ||
                                                    (!$isPerlengkapanDepanRoute && !$isPerlengkapanDepanCategory))
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            ...
                            <div id="edit-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('update.perlengkapan-depan', ['id' => $item->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('patch')
                            ...
                            <div id="itemIn-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('itemIn.perlengkapan-depan', ['id' => $item->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('patch')
                            ...
                            <div id="itemOut-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('itemOut.perlengkapan-depan', ['id' => $item->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('patch')
                                            <div class="modal-body d-flex justify-content-center align-items-center">
                            ...
                            <div id="delete-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                    <div class="modal-content">
                                        <form action="{{ route('destroy.perlengkapan-depan', ['id' => $item->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('delete')
                                            <div class="modal-body d-flex justify-content-center align-items-center">
        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                <div class="bg-light text-center rounded p-4 h-100">
                    ...
                    <canvas height="250" id="perlengkapanDepanChart"></canvas>
                </div>
            </div>
            <div class="col-sm-12 col-xl-6 hidden" id="monthlyContainer">
                <div class="bg-light text-center rounded p-4 h-100">
                    ...
                    <canvas height="250" id="monthPerlengkapanDepanChart"></canvas>
                </div>
            </div>
            <div class="col-sm-12 col-xl-6">
                <div class="bg-light text-center rounded p-4 h-100">
                    ...
                    <canvas height="250" id="perlengkapanDepanStok"></canvas>
                </div>
            </div>
        </div>
    </div>
...
@section('jsPage')
    <script>
        ...
        $(document).ready(function() {
            var ctx1 = $("#perlengkapanDepanChart").get(0).getContext("2d");
        ...
        $(document).ready(function() {
            var ctx1 = $("#monthPerlengkapanDepanChart").get(0).getContext("2d");
        ...
        document.addEventListener("DOMContentLoaded", function() {
            var ctx1 = document.getElementById("perlengkapanDepanStok").getContext("2d");
        ...
        document.getElementById('showMonthlyButton').addEventListener('click', function() {
            ...
            document.getElementById('perlengkapanDepanChart').parentElement.parentElement.classList.add('hidden');
        });
        ...
        document.getElementById('showDailyButton').addEventListener('click', function() {
            ...
            document.getElementById('perlengkapanDepanChart').parentElement.parentElement.classList.remove(
                'hidden');
        });
    </script>
@endsection
