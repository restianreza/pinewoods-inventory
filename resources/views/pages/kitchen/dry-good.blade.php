                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-header" style="display: flex; justify-content: center;">
                            <h2 class="fw-medium fs-base">Tambah List Dry Good</h2>
                        </div>

                        <!-- BEGIN: Modal Body -->
                        <form action="{{ route('create.dry-good') }}" method="POST">
                            @csrf
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <select id="category" name="category_id" class="form-select">
                                        ...
                                        @foreach ($categories as $category)
                                            @php
                                                $isDryGoodRoute = Route::is('dry-good');
                                                $isDryGoodCategory =
                                                    strtolower($category->category_name) === 'dry good';
                                            @endphp
                                            @if (($isDryGoodRoute && $isDryGoodCategory) || (!$isDryGoodRoute && !$isDryGoodCategory))
                    ...
                    <tbody>
                        @foreach ($items as $item)
                            ...
                            <div id="itemIn-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('itemIn.dry-good', ['id' => $item->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('patch')
                            ...
                            <div id="edit-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('update.dry-good', ['id' => $item->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('patch')
                            ...
                            <div id="itemOut-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('itemOut.dry-good', ['id' => $item->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('patch')
                                            <div class="modal-body d-flex justify-content-center align-items-center">
                            ...
                            <div id="delete-{{ $item->id }}" class="modal fade" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                    <div class="modal-content">
                                        <form action="{{ route('destroy.dry-good', ['id' => $item->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('delete')
                                            <div class="modal-body d-flex justify-content-center align-items-center">
        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-6">
                <div class="bg-light text-center rounded p-4 h-100">
                    ...
                    <canvas height="250" id="dryGoodChart"></canvas>
                </div>
            </div>
            <div class="col-sm-12 col-xl-6 hidden" id="monthlyContainer">
                <div class="bg-light text-center rounded p-4 h-100">
                    ...
                    <canvas height="250" id="monthDryGoodChart"></canvas>
                </div>
            </div>
            <div class="col-sm-12 col-xl-6">
                <div class="bg-light text-center rounded p-4 h-100">
                    ...
                    <canvas height="250" id="dryGoodStok"></canvas>
                </div>
            </div>
        </div>
    </div>
...
@section('jsPage')
    <script>
        ...
        $(document).ready(function() {
            var ctx1 = $("#dryGoodChart").get(0).getContext("2d");
        ...
        $(document).ready(function() {
            var ctx1 = $("#monthDryGoodChart").get(0).getContext("2d");
        ...
        document.addEventListener("DOMContentLoaded", function() {
            var ctx1 = document.getElementById("dryGoodStok").getContext("2d");
        ...
        document.getElementById('showMonthlyButton').addEventListener('click', function() {
            ...
            document.getElementById('dryGoodChart').parentElement.parentElement.classList.add('hidden');
        });
        ...
        document.getElementById('showDailyButton').addEventListener('click', function() {
            ...
            document.getElementById('dryGoodChart').parentElement.parentElement.classList.remove('hidden');
        });
    </script>
@endsection
