...
class PerlengkapanDapurController extends Controller
{
    public function index()
    {
        $categories = Categorie::all();
        $data = Item::with('categorie')->whereHas('categorie', function ($query) {
            $query->where('category_name', 'Perlengkapan Dapur');
        })->get();
        $showcaseCategory = Categorie::where('category_name', 'Perlengkapan Dapur')->first();

        if (!$showcaseCategory) {
            return view('pages.kitchen.perlengkapan-dapur', compact('categories'))->with('errors', 'Perlengkapan Dapur category not found');
        }
        ...
        $riwayat = History::where('action_category', 'Perlengkapan Dapur')->whereBetween('created_at', [Carbon::now()->startOfMonth(), Carbon::now()->endOfMonth()])->orderBy('created_at', 'desc')->get();


        return view('pages.kitchen.perlengkapan-dapur', compact('data', 'categories', 'items', 'histories', 'itemNames', 'itemQuantities', 'riwayat', 'monthHistories'));
    }
    ...
    public function create(Request $request)
    {
        ...
        History::create([
            ...
            'action' => "Create",
            'action_category' => 'Perlengkapan Dapur',
            'item_id' => $item->id,
