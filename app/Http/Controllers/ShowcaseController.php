...
class ShowcaseController extends Controller
{
    public function index()
    {
        ...
        $data = Item::with('categorie')->whereHas('categorie', function ($query) {
            $query->where('category_name', 'Show Case');
        })->get();
        $showcaseCategory = Categorie::where('category_name', 'Show Case')->first();

        if (!$showcaseCategory) {
            return view('pages.tim-depan.showcase', compact('categories'))->with('errors', 'Show Case category not found');
        }
        ...
        $riwayat = History::where('action_category', 'Show Case')->whereBetween('created_at', [Carbon::now()->startOfMonth(), Carbon::now()->endOfMonth()])->orderBy('created_at', 'desc')->get();


        return view('pages.tim-depan.showcase', compact('data', 'categories', 'items', 'histories', 'itemNames', 'itemQuantities', 'riwayat', 'monthHistories'));
    }
