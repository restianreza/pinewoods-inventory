...
class PerlengkapanAreaLuarController extends Controller
{
    public function index()
    {
        $categories = Categorie::all();
        $data = Item::with('categorie')->whereHas('categorie', function ($query) {
            $query->where('category_name', 'Perlengkapan Area Luar');
        })->get();
        $showcaseCategory = Categorie::where('category_name', 'Perlengkapan Area Luar')->first();

        if (!$showcaseCategory) {
            return view('pages.cleaning-service.perlengkapan-area-luar', compact('categories'))->with('errors', 'Perlengkapan Area Luar category not found');
        }
        ...
        $riwayat = History::where('action_category', 'Perlengkapan Area Luar')->whereBetween('created_at', [Carbon::now()->startOfMonth(), Carbon::now()->endOfMonth()])->orderBy('created_at', 'desc')->get();


        return view('pages.cleaning-service.perlengkapan-area-luar', compact('data', 'categories', 'items', 'histories', 'itemNames', 'itemQuantities', 'riwayat', 'monthHistories'));
    }
    ...
    public function create(Request $request)
    {
        ...
        History::create([
            ...
            'action' => "Create",
            'action_category' => 'Perlengkapan Area Luar',
            'item_id' => $item->id,
